...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 09, 2025 at 07:32 PM
...
CREATE TABLE `branches` (
  ...
  `custom_interest_rate1` decimal(5,2) DEFAULT NULL COMMENT 'custom interest for motorcyle',
...
INSERT INTO `branches` (`branch_id`, `branch_name`, `branch_address`, `branch_phone`, `status`, `interest_rate`, `custom_interest_rate1`, `custom_interest_rate2`, `custom_interest_rate3`, `cash_on_hand`, `created_at`) VALUES
(1, 'Calbayog Branch - Main', 'Navarro St., Calbayog City, Samar', '09171234567', 'active', 0.06, 0.08, NULL, NULL, 0.00, '2025-08-14 12:57:02'),
(2, 'Gandara Branch', 'Gandara Samar', '09181234567', 'active', 0.06, 0.08, NULL, NULL, 0.00, '2025-08-14 12:57:02');
...
(35, 'CARDO DALISAY', '09123456789', 'BRGY. CAPOOCAN', NULL, '2025-09-08 11:49:15');
...
(1, 10000.00, 10, 'excel', '', 'manual', '2025-09-07 04:04:28', 60);
...
(8, NULL, 'super_admin', '$2y$10$RCfvdDWOKIKaA9yWjuJS6ObLGRyVjE.pHifIFYarTYhr5COZtnLRm', 'super_admin', 'Super Admin', 'active', '2025-09-09 21:36:52', 'uploads/avatars/user_8_1756613481.jpg', '2025-08-14 13:36:07'),
(9, 1, 'cashier_main_husay', '$2y$10$kv8rvQan1kyfYMGFZrkv.eeWUols7muHzSbyHz40QrQrcPWqD6DV6', 'cashier', 'Cashier Husay Daw', 'active', '2025-09-08 19:55:43', 'uploads/avatars/avatar_68b33b667927f.jpg', '2025-08-14 13:36:07'),
...
(12, 1, 'admin_main', '$2y$10$Q..9xrdBpGrXd3p.j66mC.Sye20TmUmYRYy9Zuc.BPdhc1TgiO95C', 'admin', 'Admin Main User', 'active', '2025-09-09 18:42:35', 'uploads/avatars/avatar_68b3c90c783b1.jpg', '2025-08-14 13:36:07'),
...
--
ALTER TABLE `audit_logs`
  MODIFY `log_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1194;
...
--
ALTER TABLE `cash_ledger`
  MODIFY `ledger_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=767;

--
-- AUTO_INCREMENT for table `claims`
--
ALTER TABLE `claims`
  MODIFY `claim_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=213;
...
--
ALTER TABLE `pawned_items`
  MODIFY `pawn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=396;
...
--
ALTER TABLE `tubo_payments`
  MODIFY `tubo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

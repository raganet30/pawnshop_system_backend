            ...
            <form id="tuboPaymentForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-3" id="tpRemainingWrapper">
                            <label id="tpRemainingAmountLabel" class="form-label">Remaining Amount Pawned</label>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control" id="tpDatePaid" name="tpDatePaid" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Months Covered</label>
                            <input type="text" class="form-control" id="tpMonthsCovered" name="tpMonthsCovered"
                                readonly>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Interest Amount</label>
                            <input type="text" class="form-control" id="tpInterestAmount" name="tpInterestAmount"
                                readonly>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">New Due Date</label>
                            <input type="text" class="form-control" id="tpNewDueDate" name="tpNewDueDate" readonly>
                        </div>
